...
class UIConfig {
  ...
  static final double fontSizeSubMain =
      ScreenUtil().setSp(46); // 关于我们、反馈、检查更新正文
  static final double fontSizeMid = ScreenUtil().setSp(46); // TextField 快捷入口
  static final double fontSizeMin = ScreenUtil().setSp(44); // 校区&运营商
