...
import '../config.dart';
import '../main.dart';
import '../update/update_Alert_Icon.dart';
...
class _UpdatecheckButtonState extends State<UpdatecheckButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
        onTap: () {
          _existNewVersioner.checkvisit();
          checkUpgrade(context,auto: false);
        },
        child: SizedBox(
          width: 370,
          child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  if (_existNewVersioner.existNewVersion) Expanded(child: UpdateAlertIcon(),),
                  SizedBox(width: 3,),
                  Icon(Icons.keyboard_arrow_right_rounded,size: UIConfig.fontSizeMin * 2.5,),
                ],
              )
